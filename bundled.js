...
function resetHome(next) {
  let homeLogo = next.querySelector(".hero-logo");
...
function initHomeLoader() {
  ...
  let homeLogo = document.querySelector(".hero-logo");
  ...
  gsap.delayedCall(0.5, () => {
    ...
    tl.to([homeCenter, homeVidWrap], {
      ...
      .fromTo(
        [homeTitle, homeLogo],
        { opacity: 0, y: "2em" },
        { opacity: 1, y: "0em", duration: 0.5, stagger: 0.1 },
      )
      .fromTo(
...
function initHomeParallax(container) {
  ...
  homeParallax
    .to('[data-home-parallax="target"]', { yPercent: 80, ease: "linear" })
    .to('[data-home-parallax="overlay"]', { opacity: 0.8, ease: "linear" }, 0)
    .to(".hero-logo", { y: "-28vh", width: "6em", ease: "linear" }, 0);
