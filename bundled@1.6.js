...
function initVideos(next) {
  ...
  vids.forEach((vid, index) => {
   ...
   const fullscreenBtn = vid.querySelector('[data-vimeo-control="fullscreen"]');
    ...
    if (fullscreenBtn) {
      fullscreenBtn.addEventListener('click', () => {
        ...
        if (isFullscreen) {
          // Exit fullscreen
          vid.setAttribute('data-vimeo-fullscreen', 'false');
          ...
          // Enter fullscreen
          vid.setAttribute('data-vimeo-fullscreen', 'true');
    ...
    const handleFullscreenChange = () => {
      ...
      vid.setAttribute('data-vimeo-fullscreen', isFullscreen ? 'true' : 'false');
    };
